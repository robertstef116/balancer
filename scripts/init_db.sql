...
VALUES ('root', 'admin'),
       ('test', 'test') ON CONFLICT DO NOTHING;
...
VALUES ('7a0acdc5-9dd0-467a-9c92-9569d47eac1b', 'worker 1', '192.168.100.92', 8081, true),
       ('d0cb107a-78a5-4e1b-bde2-0318701ac329', 'worker 2', '192.168.100.93', 8081, true) ON CONFLICT DO NOTHING;
...
VALUES ('2307b2af-dc14-4737-b26b-3f68a9c5667g', 'nginx:latest', 1073741824, 'RANDOM', 3),
       ('e615b36a-cb04-11ec-9d64-0242ac120002', 'r0bb3rt17/test-image:latest', 1073741824, 'RANDOM',
...
VALUES ('/test-flow', '2307b2af-dc14-4737-b26b-3f68a9c5667g', 80),
       ...
       ('/testx', 'e615b36a-cb04-11ec-9d64-0242ac120002', 8080) ON CONFLICT DO NOTHING;
